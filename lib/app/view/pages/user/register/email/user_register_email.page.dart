...
import 'package:learning_about_b4a_flutter_2/app/view/controllers/user/register/email/user_register_email_controller.dart';
import 'package:learning_about_b4a_flutter_2/app/view/pages/utils/app_button.dart';
import 'package:learning_about_b4a_flutter_2/app/view/pages/utils/app_textformfield.dart';
import 'package:validatorless/validatorless.dart';

class UserRegisterEmailPage extends StatefulWidget {
  final _userRegisterEmailController = Get.find<UserRegisterEmailController>();
                        ...
                        children: [
                          ...
                          AppButton(
                            ...
                            onPressed: () {
                              ...
                              if (formValid) {
                                log('formValid');
                                widget._userRegisterEmailController
                                    .registerEmail(
